...
<body>
    ...
    <header class="header">
      ...
      <div class="dropdown-menu">
        ...
        <a target="form5" href="program.php">Programming & Tech</a>
      ...
      session_start();
        include '../PHP Connectivity/connect.php';
          $select_query = "select * from professional_skills natural join professionals where domain_id=5 and availability>0";
